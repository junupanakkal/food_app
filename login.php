...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form method="post" action="routers/router.php" class="login-form" id="form" autocomplete="on">
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text">Login for Junusha Food App System</p>
          </div>
        </div>
        <div class="row margin" autocomplete="on">
