...
{
	header("location:login_vehicle_number.php");
}
else{
?>
<!DOCTYPE html>
      ...
      <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php" novalidate="novalidate" class="col s12">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="username" class="center-align">VehicleNumber</label>
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input name="email" id="email" type="text" data-error=".errorTxt5">
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
            <p class="margin center medium-small sign-up">Already have an account? <a href="login_vehicle_number.php">Login</a></p>
          </div>
        </div>
      </form>
    </div>
